...
class Pipe:
    ...
    def fit(self, x_train: pd.DataFrame, y_train: pd.Series,
        ...
        if self.calibration_status:
            ...
            cal_model = LogisticRegression(random_state=RANDOM_SEED,
...
class LAMA:
    def __init__(self, dataframe_name: str, estimator_name: str,
        ...
        self.final_model = TabularAutoML(task=self.task, timeout=2000, reader_params={'cv': 5,
    ...
    def fit(self, train: pd.DataFrame, val: pd.DataFrame, cat: list, num: list, target: str):
        ...
        if self.calibration_status:
            ...
            cal_model = LogisticRegression(random_state=RANDOM_SEED, class_weight={0: 1, 1: w1})
